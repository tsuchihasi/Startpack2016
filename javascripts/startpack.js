...
$(function(){
    $("ul.service_right li:not("+$("ul.service_buttons li a.selected").attr("href")+")").hide()
    $("ul.service_buttons li a").click(function(){
        $("ul.service_buttons li a").removeClass("selected");
